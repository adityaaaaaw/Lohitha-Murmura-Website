    ...
    >
      ...
      <div className="grid grid-cols-3" style={{ paddingBottom: 'env(safe-area-inset-bottom)' }}>
        ...
        <a
          ...
          className="flex flex-col items-center justify-center gap-1 py-3 min-h-[64px] text-text hover:bg-primary/5 active:bg-primary/10 transition-colors border-r border-border focus-visible:outline-2 focus-visible:outline-primary"
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="flex flex-col items-center justify-center gap-1 py-3 min-h-[64px] bg-[#25D366] hover:bg-[#1da851] active:bg-[#168a40] transition-colors focus-visible:outline-2 focus-visible:outline-white"
        ...
        <Link
          to="/cart"
          className="relative flex flex-col items-center justify-center gap-1 py-3 min-h-[64px] text-text hover:bg-primary/5 active:bg-primary/10 transition-colors border-l border-border focus-visible:outline-2 focus-visible:outline-primary"
