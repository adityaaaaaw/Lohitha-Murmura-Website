...
const contactCards = [
  {
    ...
    action: { label: 'Get Directions', href: MAPS_LINK, external: true, style: 'btn-secondary' },
  },
  {
    id: 'phone',
    icon: Phone,
    ...
    action: { label: 'Call Now', href: `tel:${PHONE_NUMBER}`, style: 'btn-accent' },
  },
  {
    id: 'whatsapp',
    icon: MessageCircle,
  ...
  <section id="contact" className="section-padding bg-white" aria-label="Contact information">
    <div className="container-custom">
      ...
      <motion.div
        ...
        variants={fadeUp}
      >
        <span className="badge-primary mb-3 inline-block">Get In Touch</span>
      ...
      {/* Contact Cards — single col mobile, 2 col sm, 4 col lg */}
      <motion.div
            ...
            >
              ...
              {card.action && (
                <a
                  ...
                  className={`
                    flex items-center justify-center gap-2 w-full py-3 rounded-xl text-sm font-semibold font-heading min-h-[48px] transition-all duration-200
                    ${card.action.style === 'whatsapp'
                      ? 'bg-[#25D366] text-white hover:bg-[#1da851]'
                      : card.action.style === 'btn-accent'
      ...
      {/* Quick action row — full width on mobile */}
      <div className="flex flex-col sm:flex-row gap-3 mb-10 sm:mb-14">
        <a
          href={`tel:${PHONE_NUMBER}`}
          className="flex-1 flex items-center justify-center gap-2 min-h-[52px] btn-secondary text-base rounded-xl"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="flex-1 flex items-center justify-center gap-2 min-h-[52px] btn-primary text-base rounded-xl"
        >
      ...
      >
        <div className="relative w-full" style={{ paddingBottom: '56.25%' /* 16:9 */ }}>
          <iframe
            title="Lohitha Murmura Factory Location — Siddipet, Telangana"
        ...
        <div className="bg-white px-4 sm:px-6 py-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex items-center gap-1.5 text-primary text-sm font-semibold whitespace-nowrap hover:underline flex-shrink-0 min-h-[44px]"
          >
